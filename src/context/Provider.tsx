...
export const DropzoneStateContext = createContext<TRecordOfReducerState | null>(
  null,
);
export const DropzoneDispatchContext = createContext<Dispatch<
  IPayloadAction<never>
> | null>(null);
